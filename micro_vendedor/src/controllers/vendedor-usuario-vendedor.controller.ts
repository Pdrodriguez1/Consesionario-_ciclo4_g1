...
export class VendedorUsuarioVendedorController {
  ...
  async get(
    ...
    return this.vendedorRepository.Tiene_solo_un(id).get(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.Tiene_solo_un(id).create(usuarioVendedor);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.Tiene_solo_un(id).patch(usuarioVendedor, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.Tiene_solo_un(id).delete(where);
  }
}
